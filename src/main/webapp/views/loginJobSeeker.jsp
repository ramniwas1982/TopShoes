                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                 <span> ${invalidPass}</span>
                                    <div class="card-header"><h1 class="text-center font-weight-light my-4">B2B Login</h1></div>
                                    <div class="card-body">
                                        <form action="jobSeekerValidation">
                                            <div class="form-group">
                                                <label class="small mb-1" for="inputEmailAddress">Email</label>
                                                <input class="form-control py-4" name="inputEmailAddress" id="inputEmailAddress" type="email" placeholder="Enter email address" />
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="card-footer text-center">
                                        <div class="small"><a href="registerJobSeeker">Need an account? Sign up!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>

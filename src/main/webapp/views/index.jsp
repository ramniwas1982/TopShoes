    ...
    <header class="header-area header_shadow">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="registerJobSeeker">Register</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="#">Candidates</a>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    <li><a href="loginJobSeeker">Employer Login</a></li>
                            ...
                            <li><a href="loginJobSeeker">Log In</a></li>
        ...
        <div class="header-banner d-lg-flex align-items-center">
                        ...
                        <div class="header-banner-content">
                            ...
                            <div class="header-search">
                                ...
                                <div class="header-sign">
                                    <p><a href="registerJobSeeker">Sign up now</a> to get started!</p>
                                </div>
                            </div>
            ...
            <div class="header-banner-image d-flex align-items-center justify-content-end">
                <div class="image">
                    <img src="assets/images/header_banner.png" alt="header banner">
                </div> <!-- image -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="single_jobs text-center mt-30">
                                ...
                                <div class="jobs_content">
                                    <h4 class="jobs_title"><a href="job-alerts.html">Graphic Designer</a></h4>
